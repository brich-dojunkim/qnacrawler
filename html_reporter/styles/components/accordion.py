...
.analysis-toggle-controls input[type="radio"] {
    display: none;
}
...
.analysis-toggle-controls input[type="radio"]:checked + .toggle-btn {
    color: white;
    background: linear-gradient(135deg, #667eea, #764ba2);
    box-shadow: 0 2px 8px rgba(102, 126, 234, 0.3);
}

.toggle-btn:hover:not(.analysis-toggle-controls input[type="radio"]:checked + .toggle-btn) {
    background: #f1f5f9;
    color: #374151;
}
...
.analysis-toggle-controls input[type="radio"]:checked + .toggle-btn:not(:last-child) {
